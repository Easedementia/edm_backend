"""
Django settings for edm_backend project.
...
SECRET_KEY = 'django-insecure-5&b(x!d=(@+#!)x(@l&x%))au^3(+rq)j3qap%=y3wnt6u*2+&'
...
#     'user_side.backends.EmailBackend',            # custom
# ]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'roshan.easedementia@gmail.com'
